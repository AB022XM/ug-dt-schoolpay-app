...
To build the final jar and optimize the schoolpayApp application for production, run:
...
Then navigate to [http://localhost:9002](http://localhost:9002) in your browser.
