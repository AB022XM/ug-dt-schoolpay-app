...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ug.co.absa.africa.schoolpay.service.EmailAlreadyUsedException ||
            ex instanceof ug.co.absa.africa.schoolpay.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ug.co.absa.africa.schoolpay.service.InvalidPasswordException
